...
int send_output(mpz_t message1,mpz_t message2){
	...
	char* filename1 = "./output_ELGAMAL.txt";
...
int generate_p_q_g_j(mpz_t p, mpz_t q , mpz_t g, mpz_t j){
